...
const Settings = ({navigation}) => {
  ...
  const user =
    state.user != null
      ? state.user
      : {firstName: '', lastName: '', joined: Date.now()};
    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
        ...
        <View style={styles.headerContainer}>
          <Text
            style={[Typography.H1, {color: Colors.WHITE, marginBottom: 10}]}>
            Settings
          </Text>
        </View>
        ...
        <View style={styles.bodyContainer}>
          ...
          <View>
            <Text
              style={[
                Typography.TAGLINE,
                {color: Colors.GRAY_MEDIUM, marginBottom: 10},
              ]}>
              Account
            </Text>
            <View style={styles.blockContainer}>
              ...
              <View style={styles.rowContainer}>
                ...
                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM}]}>
                  {user.firstName}
                </Text>
              </View>
          ...
          <View style={{marginTop: 20}}>
            ...
            <View style={styles.blockContainer}>
              ...
              <Bar padding={0.3} color={Colors.GRAY_THIN} />
              <TouchableOpacity activeOpacity={0.8} style={styles.rowContainer}>
                <Text style={[Typography.BODY, {color: Colors.WHITE}]}>
                  Language
                </Text>
                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM}]}>
          ...
          <View style={{marginTop: 20}}>
            ...
            <View style={styles.blockContainer}>
              <Pressable
                style={styles.rowContainer}
                onPress={() => Linking.openURL('https://www.blaiti.com')}>
                <Text style={[Typography.BODY, {color: Colors.WHITE}]}>
                  Developer
                </Text>
                <Text style={[Typography.TAGLINE, {color: Colors.GRAY_MEDIUM}]}>
