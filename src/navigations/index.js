...
import AddIcome from '../screens/transactions/add-income';
import AddExpense from '../screens/transactions/add-expense';
...
function MyTabs() {
  return (
    <Tab.Navigator
      ...
      barStyle={[
        Typography.BODY,
        {backgroundColor: Colors.BLACK, borderTopWidth: 0.3},
      ]}>
      <Tab.Screen
        name={routes.Home}
        component={Home}
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({color}) => <Icon name="gift" color={color} size={23} />,
        }}
      />
      <Tab.Screen
      ...
      <Stack.Navigator
        ...
        {state.isLoading ? (
          ...
          <>
            ...
            />
            <Stack.Screen name={routes.AddIcome} component={AddIcome} />
